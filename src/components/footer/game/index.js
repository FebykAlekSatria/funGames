function FooterGame() {
    return (
        <footer className="text-gray-600 body-font float-bottom">
            <div className="container px-5 py-5 mx-auto flex items-center md:flex-row flex-col">
                <div className="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
                    <h2 className="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">funGAMES</h2>
                </div>
                <div className="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
                    <button
                        ...
                        <span className="ml-4 flex items-start flex-col leading-none">
                            <span className="text-xs text-gray-600 mb-1">Lihat</span>
                            <span className="title-font font-medium">Chat Room</span>
                        </span>
                    </button>
                    <button
                        className="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none shadow">
                        ...
                        <span className="ml-4 flex items-start flex-col leading-none">
                            <span className="text-xs text-gray-600 mb-1">Lihat</span>
                            <span className="title-font font-medium">Peserta Room</span>
                        </span>
                    </button>
                </div>
            </div>
